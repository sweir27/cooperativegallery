...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MainContent.show_start'
        db.add_column(u'gallery_site_maincontent', 'show_start',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 8, 11, 0, 0)),
                      keep_default=False)

        # Adding field 'MainContent.show_end'
        db.add_column(u'gallery_site_maincontent', 'show_end',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 8, 11, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MainContent.show_start'
        db.delete_column(u'gallery_site_maincontent', 'show_start')

        # Deleting field 'MainContent.show_end'
        db.delete_column(u'gallery_site_maincontent', 'show_end')
