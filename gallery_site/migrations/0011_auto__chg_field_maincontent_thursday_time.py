...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MainContent.thursday_time'
        db.alter_column(u'gallery_site_maincontent', 'thursday_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'MainContent.thursday_time'
        db.alter_column(u'gallery_site_maincontent', 'thursday_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 17, 0, 0)))
    ...
    models = {
        ...
        u'gallery_site.maincontent': {
            ...
            'thursday_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
